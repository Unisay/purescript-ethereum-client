...
# of coinbase transactions:        """ <> show (maybe zero unwrap accountTxCount) <> """
# of transactions by hash:         """ <> show (maybe zero unwrap blockTxCountByHash) <> """
# of transactions by block:        """ <> show (maybe zero unwrap blockTxCountByBlock) <> """
# of uncles in a block by hash:    """ <> show (maybe zero unwrap uncleCountByHash) <> """
# of uncles in a block by block:   """ <> show (maybe zero unwrap uncleCountByBlock) <> """
